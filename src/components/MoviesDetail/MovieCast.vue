<template>
  <div class="movie-cast">
      <div style='padding:5px 0' class="container">
        <div style='fontSize:22px;borderBottom:5px solid var(--bs-teal);width:100px' class='center'>CAST <span style='marginLeft:5px;fontSize:16px;color:green' class='center'><ion-icon style='marginRight:5px;fontSize:8px' name="ellipse"></ion-icon> {{cast.length}}</span></div>
        <div v-if='cast.length>0' class="mc-casts">
          <carousel style='position:relative' :autoHeight="true" :dots="false" :autoplay="false" :nav="false" :items=5 >
            ...
            <card-person v-for='p in cast' :key='p.cast_id' :cast='p'/>
